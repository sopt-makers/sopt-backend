...
public class UniversityFriendRecommendRequestCreator implements FriendRecommendRequestCreator {

    @Override
    public RecommendFriendRequest create(OwnPlaygroundProfile userPlaygroundProfile) {
        return null;
    }

...
BLUE_PORT=9090
BLUE_ACTUATOR_PORT=9190
GREEN_CONTAINER_NAME="app-green"
GREEN_PORT=9091
GREEN_ACTUATOR_PORT=9191
...
if [ "$RUNNING_SERVER_PORT" == "$BLUE_PORT" ]; then # Green Up
  ...
  DEPLOY_TARGET_ACTUATOR_PORT=${GREEN_ACTUATOR_PORT}
  ...
  DEPLOY_TARGET_ACTUATOR_PORT=${BLUE_ACTUATOR_PORT}
else
...
deploy_container "${DEPLOY_TARGET_CONTAINER_NAME}" ${DEPLOY_TARGET_PORT} ${DEPLOY_TARGET_ACTUATOR_PORT}
...
reload_nginx ${DEPLOY_TARGET_PORT} ${DEPLOY_TARGET_ACTUATOR_PORT}
